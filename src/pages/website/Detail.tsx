...
const Detail = (props: Props) => {
        ...
        <div>
          ...
          <div className="detail_block_two" id="detail_block_two">
            <div>
              ...
              <section>
                ...
                <p>
                  {hotel?.location}, {hotel?.city_name}, Việt Nam
                </p>
              </section>
            </div>
            <div>
          ...
          <div className="detail_block_three">
            ...
            <div className="detail_block_three_small">
                {DataImage.map(item=>{
                    return(
                        <img key={item} src={URLImage + item} onClick={()=>changeImageMain(item)} />
                    )
                })}
            </div>
          </div>
  ...
  <div className="detail_block_four" id="detail_block_four">
    <div className="detail_block_four_desc">
      <p>
        Nằm ở TP. Hồ Chí Minh, cách Chùa Giác Lâm 2.9 km, Khách sạn Song
        Anh cung cấp chỗ nghỉ có Wi-Fi miễn phí và chỗ đậu xe riêng miễn
        phí. Chỗ nghỉ cách Chợ Tân Định khoảng 4.3 km, Công viên văn hóa
        Đầm Sen 4.4 km và Bảo tàng chứng tích chiến tranh 5.2 km. Chỗ nghỉ
        này cung cấp dịch vụ phòng, quầy lễ tân 24 giờ và phòng giữ hành
        lý cho khách. Tại khách sạn, mỗi phòng đều được thiết kế có ban
        công. Tại Khách sạn Song Anh, các phòng đều có điều hòa và TV màn
        hình phẳng.Chỗ nghỉ cách Dinh Thống Nhất 5.6 km và Trung Tâm
        Thương Mại Diamond Plaza 5.9 km. Sân bay gần nhất là Sân bay Quốc
        tế Tân Sơn Nhất, cách Khách sạn Song Anh 2 km.
      </p>
  ...
  <div className="detail_block_five" id="detail_block_five">
    ...
    <div>
      <section>
        <label >Ngày đặt phòng: </label><input type="date" />
      </section>
      <section>
        <label >Ngày trả phòng: </label><input type="date" />
      </section>
    </div>
    <table>
      <thead>
      ...
      <tbody>
        <tr>
            ...
            <h6 onClick={handleDisplayImage}>Xem ảnh</h6>
                {
                    (isImagesVisible && (
                        ...
                        {DataImage.map(item=>{
                            return(
                        <img key={item} src={URLImage+ item} alt=""  width={200} onClick={()=>changeImageRoom(item)}/>
                            )
                        })}
                        </section>
          ...
          <td>2</td>
          <td>
            <h5>VND <span className="priceRoom">100</span>.000</h5>
          </td>
          <td>10</td>
          <td>
            <input className="changeQuantityRoom" type="number" defaultValue={2} min={0} max={10} />
          </td>
          <td rowSpan={2}>
            <h4><span id="quantityRoom" /> phòng giá:</h4>
            <h5>VND <span id="totalPrice" />.000</h5>
        ...
        <tr>
          ...
          <td>4</td>
          <td>
            <h5>VND <span className="priceRoom">366</span>.000</h5>
          </td>
          <td>10</td>
          <td>
            <input className="changeQuantityRoom" type="number" defaultValue={0} min={0} max={10} />
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <div className="detail_block_six">
    ...
    <p>
      Chỗ nghỉ này cho biết họ đã áp dụng các biện pháp cụ thể ở một số
      hoặc tất cả các hạng mục này: rác thải, nước, năng lượng và khí nhà
      kính, điểm đến và cộng đồng, cũng như môi trường tự nhiên.
    </p>
  </div>
  <div className="detail_block_seven" id="detail_block_seven">
    ...
    <div className="detail_block_seven_detail">
      <section>
        ...
        <input type="range" min={0} max={10} defaultValue={4} disabled />
      </section>
      <section>
          ...
          <div className="detail_block_seven_comment_hiden_bot_detail">
            ...
            <section className="detail_block_seven_comment_hiden_bot_comment">
              ...
              <p className="detail_block_seven_comment_hiden_bot_comment_p">
                Tv không hoạt động, ổ cắm điện chính không hoạt động. Nước
                nóng yếuTv không hoạt động, ổ cắm điện chính không hoạt
                động. Nước nóng yếuTv không hoạt động, ổ cắm điện chính
                không hoạt động. Nước nóng yếuTv không hoạt động, ổ cắm
                điện chính không hoạt động. Nước nóng yếu Tv không hoạt
                động, ổ cắm điện chính không hoạt động. Nước nóng yếuTv
                không hoạt động, ổ cắm điện chính không hoạt động. Nước
                nóng yếuTv không hoạt động, ổ cắm điện chính không hoạt
                động. Nước nóng yếuTv không hoạt động, ổ cắm điện chính
                không hoạt động. Nước nóng yếu Tv không hoạt động, ổ cắm
                điện chính không hoạt động. Nước nóng yếuTv không hoạt
                động, ổ cắm điện chính không hoạt động. Nước nóng yếuTv
                không hoạt động, ổ cắm điện chính không hoạt động. Nước
                nóng yếuTv không hoạt động, ổ cắm điện chính không hoạt
                động. Nước nóng yếu
    ...
    <div className="detail_block_eight_content">
      ...
      <section>
        ...
        <div>
          ...
          <p>
            Để xem thông tin giá và tình trạng phòng trống chính xác, vui
            lòng thêm số lượng và độ tuổi của trẻ em trong nhóm của bạn
            khi tìm kiếm.
          </p>
        </div>
      </section>
